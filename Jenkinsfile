	...
	stages {
		stage('Build') {
			steps {
				...
				archiveArtifacts artifacts: 'oxygen-fonts/Regular-400/Dbdoczygen-Sans.otf'
				...
				archiveArtifacts artifacts: 'oxygen-fonts/Bold-700/Dbdoczygen-Sans-Bold.otf'
				...
				archiveArtifacts artifacts: 'oxygen-fonts/Mono-400/Dbdoczygen-Mono.otf'
